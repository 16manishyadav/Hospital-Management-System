            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="type-patient.php"><i class="fa fa-cubes"></i> <span>Patients Report</span></a>
                        </li>
                        <li>
                            <a href="check-availability.php"><i class="fa fa-heartbeat"></i> <span>Doctors Availability</span></a>
                        </li>
